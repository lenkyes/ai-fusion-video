...
3A. **多人解剖与站位稳定**：同屏多人时优先使用中景、近景或半身构图，最多突出 2 个主要人物；先明确每个人在画面左/中/右、前景/背景的位置、朝向、身高关系和彼此间距，再描述动作。所有人物保持自然人体比例，头、颈、肩、躯干、腰胯和四肢长度稳定，脊柱与关节连接自然；人物身体不得被纵向拉长，不得共享、融合或交叉肢体。多人只做各自独立的小幅动作，避免全身大幅运动、拥挤遮挡、贴身交叉、前后穿越或同时转身。若多人动作复杂，改为固定镜头并只让一个人执行主要动作，其他人保持稳定姿态与视线反应。
...
10. **减少负面提示**：只在末尾保留一句与本镜头最相关的稳定约束。多人镜头优先使用“所有人物人体比例自然稳定，躯干不拉长，肢体不融合、不交叉穿透”这一句；其他镜头可使用“人物面部、手部和服装保持稳定，画面中不出现文字”。禁止堆叠长串“不要/禁止/严禁”或把 `negativeConsistencyRules` 全量复制进 prompt。
